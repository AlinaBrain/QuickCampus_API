...
namespace QuickCampusAPI.Controllers
{
    ...
    public class SubjectController : ControllerBase
    {
        ...
        public SubjectController(ISubjectRepo subjectRepo, IConfiguration configuration, IUserAppRoleRepo userAppRoleRepo, IUserRepo userRepo)
        {
        ...
        [HttpPost]
        [Route("UpdateSubject")]
        public async Task<IActionResult> UpdateSubject(AddSubjectVm vm)
        {
            IGeneralResult<AddSubjectVm> result = new GeneralResult<AddSubjectVm>();
            try
            {
